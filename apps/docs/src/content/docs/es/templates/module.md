...
Generadas bajo `architecture/modules/<id>/` por
...
|---|---|---|---|
| Module Design | Propósito, límites, dependencias | `architecture/modules/<id>/module-design.md` | `module-design-agent` |
| Module Stack | El stack del módulo | `architecture/modules/<id>/stack.md` | `stack-agent` |
| Module Security | Inquietudes de seguridad del módulo | `architecture/modules/<id>/security.md` | `security-agent` |
| Module Standards | Estándares del módulo | `architecture/modules/<id>/standards.md` | `standards-agent` |
| Module ADR | Decisión a nivel de módulo | `architecture/modules/<id>/adrs/` | — |
