...
description: "Standardize how `kaddo graph export` hints become precise relationship front matter. Use when: When relationship quality is partial/sparse/empty, or when reviewing `.kaddo/graph-hints.md`."
---
