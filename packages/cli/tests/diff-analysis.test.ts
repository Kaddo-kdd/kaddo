...
function makeArtifact(overrides: Partial<Artifact> = {}): Artifact {
  return {
    filePath: 'knowledge/delivery/work-items/WI-001-test.md',
    id: 'WI-001',
    type: 'feature',
    title: 'Test feature',
    summary: 'Test',
...
describe('analyzeGuard — glob matching', () => {
  ...
  it('matches across multiple artifacts', () => {
    ...
    const a2 = makeArtifact({ id: 'WI-002', filePath: 'knowledge/delivery/work-items/WI-002.md', codeGlobs: ['src/orders/**'] })
...
describe('analyzeGuard — artifact modification detection', () => {
  ...
  it('marks artifact as modified when its path appears in touched files', () => {
    ...
    const files = ['src/payments/payment.ts', 'knowledge/delivery/work-items/WI-001-test.md']
    const result = analyzeGuard(files, [artifact], true)
