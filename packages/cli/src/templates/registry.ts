...
export type KaddoTemplate = {
  ...
  relatedAgent?: string
  /**
   * Advanced templates are kept in the registry for progressive refinement but are NOT
   * generated by `kaddo bootstrap`. They appear when knowledge is split out of the
   * consolidated layer documents (e.g. business.md → problem.md, users.md, …).
   */
  advanced?: boolean
